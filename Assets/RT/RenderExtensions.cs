...
public static class RectTransformExtension
{
    ...
    public static Vector2 GetGUIElementOffset(this RectTransform rect)
    {
        ...
        {
            if (objectCorners[i].x < screenBounds.xMin) offset.x = screenBounds.xMin - objectCorners[i].x;
            if (objectCorners[i].x > screenBounds.xMax) offset.x = screenBounds.xMax - objectCorners[i].x;
            if (objectCorners[i].y < screenBounds.yMin) offset.y = screenBounds.yMin - objectCorners[i].y;
            if (objectCorners[i].y > screenBounds.yMax) offset.y = screenBounds.yMax - objectCorners[i].y;
        }
