...
public class RTDB
{
    ...
    private readonly Dictionary<string, object> m_database = new();
    ...
    public RTDB(string key1, object value1, string key2, object value2, string key3, object value3, string key4,
        object value4)
    {
        m_database[key1] = value1;
        m_database[key2] = value2;
    ...
    public RTDB(string key1, object value1, string key2, object value2, string key3, object value3, string key4,
        object value4, string key5, object value5)
    {
        m_database[key1] = value1;
        m_database[key2] = value2;
        m_database[key3] = value3;
    ...
    {
        if (m_database.ContainsKey(key)) return (float)m_database[key];
    ...
    {
        if (m_database.ContainsKey(key)) return (bool)m_database[key];
    ...
    public override string ToString()
    {
        ...
        foreach (var pair in m_database) s += pair.Key + "=" + pair.Value + " (" + pair.Value.GetType() + "), ";
    ...
    {
        var rememberStartingByte = index;
        ...
        RTUtil.SerializeInt32(index - 6, buffer,
            ref rememberStartingByte); //force index 0, and ignore what it returns, we don't care
    }
    ...
    public void SetClassVarsFromDBViaReflection(object obj)
    {
        ...
        foreach (var pair in m_database)
        {
            var field = obj.GetType().GetField(pair.Key, bindingFlags);
