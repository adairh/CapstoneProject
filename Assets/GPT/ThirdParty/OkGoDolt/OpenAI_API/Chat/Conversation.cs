...
namespace OpenAI_API.Chat
{
	...
	public class Conversation
    {
        ...
        ///     <paramref name="defaultChatRequestArgs" />.Model or falls back to
        ///     <see cref="OpenAI_API.Models.Model.ChatGPTTurbo" />
        /// </param>
        ...
        /// <summary>
        ///     After calling <see cref="GetResponseFromChatbot" />, this contains the full response object which can contain
        ///     useful metadata like token usages, <see cref="ChatChoice.FinishReason" />, etc.  This is overwritten with every
        ///     call to <see cref="GetResponseFromChatbot" /> and only contains the most recent result.
        /// </summary>
