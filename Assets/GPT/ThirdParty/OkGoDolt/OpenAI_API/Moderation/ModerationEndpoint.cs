...
namespace OpenAI_API.Moderation
{
	...
	public class ModerationEndpoint : EndpointBase, IModerationEndpoint
    {
	    ...
	    /// </summary>
	    public ModerationRequest DefaultModerationRequestArgs { get; set; } =
            new() { Model = Model.TextModerationLatest };
        ...
        {
            var req = new ModerationRequest(DefaultModerationRequestArgs.Model, input);
