	...
	public abstract class EndpointBase
    {
        ...
        protected HttpClient GetClient()
        {
            ...
            */
            ...
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", _Api.Auth.ApiKey);
        ...
        protected string GetErrorMessage(string resultAsString, HttpResponseMessage response, string name,
            string description = "")
        {
            return
        ...
        private async Task<HttpResponseMessage> HttpRequestRaw(string url = null, HttpMethod verb = null,
            object postData = null, bool streaming = false)
        {
            ...
            if (response.StatusCode == HttpStatusCode.InternalServerError)
                throw new HttpRequestException(
                    ...
                    GetErrorMessage(resultAsString, response, Endpoint, url));
        ...
        ///     couldn't be parsed.
        /// </exception>
        private async Task<T> HttpRequest<T>(string url = null, HttpMethod verb = null, object postData = null)
            where T : ApiResultBase
        {
            ...
            try
            {
                ...
                res.ProcessingTime =
                    TimeSpan.FromMilliseconds(int.Parse(response.Headers.GetValues("Openai-Processing-Ms").First()));
            ...
            {
                Debug.Print(
                    $"Issue parsing metadata of OpenAi Response.  Url: {url}, Error: {e}, Response: {resultAsString}.  This is probably ignorable.");
            }
        ...
        */
        ...
        protected async IAsyncEnumerable<T> HttpStreamingRequest<T>(string url = null, HttpMethod verb = null,
            object postData = null) where T : ApiResultBase
        {
            var response = await HttpRequestRaw(url, verb, postData, true);
            ...
            {
                Debug.Print(
                    $"Issue parsing metadata of OpenAi Response.  Url: {url}, Error: {e}.  This is probably ignorable.");
            }
