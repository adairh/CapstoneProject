...
{
	/// <summary>
	///     This class stores a snapshot of where a finger was at a specific point in time, and provides methods to look
	///     back in time to find a point based on a time.
	/// </summary>
	public class LeanSnapshot
    {
        public static List<LeanSnapshot> InactiveSnapshots = new(1000);
