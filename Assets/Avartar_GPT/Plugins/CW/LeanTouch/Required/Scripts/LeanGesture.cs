...
{
	/// <summary>
	///     This class calculates gesture information (e.g. pinch) based on all fingers touching the screen, or a specified
	///     list of fingers.
	///     NOTE: This isn't a component, so it can only be used directly from C#. Many example components make use of this
	///     class so you don't have to use code though.
	/// </summary>
	public static class LeanGesture
    {
        ...
        public static float GetLastScreenDistance(List<LeanFinger> fingers)
        {
            ...
            if (TryGetLastScreenCenter(fingers, ref center)) TryGetLastScreenDistance(fingers, center, ref distance);
        ...
        public static float GetStartScreenDistance(List<LeanFinger> fingers)
        {
            ...
            if (TryGetStartScreenCenter(fingers, ref center)) TryGetStartScreenDistance(fingers, center, ref distance);
