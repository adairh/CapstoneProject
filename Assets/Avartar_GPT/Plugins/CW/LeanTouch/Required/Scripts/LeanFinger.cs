...
namespace Lean.Touch
{
    ...
    public class LeanFinger
    {
        ...
        public List<LeanSnapshot> Snapshots = new(1000);
        ...
        /// <summary>
        ///     This will return the ray of the finger's current position relative to the specified camera (none/null = Main
        ///     Camera).
        /// </summary>
        ...
        /// <summary>
        ///     This will return the ray of the finger's start position relative to the specified camera (none/null = Main
        ///     Camera).
        /// </summary>
        ...
        /// <summary>
        ///     This will return the change in world position of this finger based on the last and current distance from the
        ///     camera.
        /// </summary>
