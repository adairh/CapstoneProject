...
{
	/// <summary>
	///     This component allows you to move the current GameObject (e.g. Camera) based on finger drags and the specified
	///     ScreenDepth.
	/// </summary>
...
namespace Lean.Touch.Editor
{
    ...
    public class LeanDragCamera_Editor : CwEditor
    {
        protected override void OnInspector()
        {
            ...
            Draw("inertia",
                "This allows you to control how much momentum is retained when the dragging fingers are all released.\n\nNOTE: This requires <b>Damping</b> to be above 0.");
            Draw("defaultPosition",
                "This allows you to set the target position value when calling the <b>ResetPosition</b> method.");
        }
    }
}
#endif