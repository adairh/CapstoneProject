...
namespace CW.Common
{
    ...
    public class CwCameraLook : MonoBehaviour
    {
        ...
        [SerializeField] private CwInputManager.Axis rollControls = new(2, true, CwInputManager.AxisGesture.Twist, 1.0f,
            KeyCode.E, KeyCode.Q, KeyCode.None, KeyCode.None, 45.0f);
