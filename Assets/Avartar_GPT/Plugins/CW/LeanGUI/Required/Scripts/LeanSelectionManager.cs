...
namespace Lean.Gui
{
    ...
    {
        private static readonly List<Selectable> tempSelectables = new();
                ...
                if (selected != null)
                {
                    ...
                    if (selectable != null)
                    {
                        for (var i = SelectionHistory.Count - 1; i >= 0; i--) // NOTE: Property
                        {
                            ...
                            if (oldSelection == null || oldSelection == selectable) selectionHistory.RemoveAt(i);
                        }
        ...
        {
            return CwHelper.Enabled(selectable) && selectable.IsInteractable() &&
        ...
        public void SelectFirstSelectable()
        {
            ...
            for (var i = 0; i < count; i++) tempSelectables.Add(tempSelectablesArray[i]);
#else
            ...
            for (var i = 0; i < tempSelectables.Count; i++)
            {
                ...
                if (CanSelect(selectable))
                {
                    ...
                    if (selectionPriority != null) priority = selectionPriority.Priority;
            ...
            if (bestSelectable != null) bestSelectable.Select();
        }
    }
}
