                ...
                if (MayDrag(eventData))
                {
                            ...
                            eventData.pressEventCamera, out vector))
                    {
                        ...
                        if (horizontal)
                        {
                            ...
                            if (horizontalClamp) sizeDelta.x = Mathf.Clamp(sizeDelta.x, horizontalMin, horizontalMax);
                        }
                        ...
                        if (vertical)
                        {
                            ...
                            if (verticalClamp) sizeDelta.y = Mathf.Clamp(sizeDelta.y, verticalMin, verticalMax);
                        }
