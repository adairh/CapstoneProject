...
namespace Lean.Gui
{
    ...
    public class LeanPulse : MonoBehaviour
    {
        ...
        public static LinkedList<LeanPulse> Instances = new();
        ...
        public void Pulse()
        {
            if (pulseTransitions != null) pulseTransitions.Begin();

            if (onPulse != null) onPulse.Invoke(remainingPulses);
        }
        ...
        public static void TryPulseAll(string name)
        {
            ...
            for (var i = Instances.Count - 1; i >= 0; i--)
            {
                ...
                if (instance.name == name) instance.TryPulse();
        ...
        public static void PulseAll(string name)
        {
            ...
            for (var i = Instances.Count - 1; i >= 0; i--)
            {
                ...
                if (instance.name == name) instance.Pulse();
