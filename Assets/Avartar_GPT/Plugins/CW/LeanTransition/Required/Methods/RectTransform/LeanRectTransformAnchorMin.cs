...
namespace Lean.Transition.Method
{
    ...
    [AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.anchorMin" +
    ...
    public class LeanRectTransformAnchorMin : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            [Tooltip("The anchorMin value will transition to this.")] [FormerlySerializedAs("AnchorMin")]
