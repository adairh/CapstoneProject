...
namespace Lean.Transition.Method
{
    ...
    [AddComponentMenu(LeanTransition.MethodsMenuPrefix + "RectTransform/RectTransform.offsetMin" +
    ...
    public class LeanRectTransformOffsetMin : LeanMethodWithStateAndTarget
    {
        ...
        public class State : LeanStateWithTarget<TARGET>
        {
            ...
            [Tooltip("The offsetMin value will transition to this.")] [FormerlySerializedAs("OffsetMin")]
