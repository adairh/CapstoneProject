...
namespace Lean.Transition
{
	...
	public abstract class LeanState
    {
        ...
        public float Remaining
        {
            ...
            {
                // Not started yet?
                if (Age < 0.0f) return float.PositiveInfinity;
        ...
        public void SkipAll()
        {
            ...
            foreach (var state in Next) state.SkipAll();
        }
        ...
        public void StopAll()
        {
            ...
            foreach (var state in Next) state.StopAll();
        }
