...
namespace Lean.Transition
{
    ...
    {
        [FormerlySerializedAs("Data.TargetAlias")]
        public string Alias;
            ...
            where T : Object
        {
            if (string.IsNullOrEmpty(Alias) == false)
            {
                ...
                {
                    if (target is T) return (T)target;
...
namespace Lean.Transition.Editor
{
    ...
    {
        private static readonly List<LeanMethod> tempMethods = new();
            ...
            if (data != null)
            {
                ...
                if (state != null && state.CanFill > -1)
                {
                    ...
                    if (GUI.Button(rectC,
                            ...
                            EditorStyles.miniButton)) state.Fill();
                    EndDisabled();
                }
            }
                    ...
                    if (methodTargetType != expectedType)
                        if (method.Alias == expectedAlias)
                        {
                            if (methodTargetType.IsSubclassOf(typeof(Component)) &&
                                expectedType.IsSubclassOf(typeof(Component))) continue;
        ...
        protected override void OnInspector()
        {
            ...
            if (dataProperty != null)
            {
                ...
                if (sTarget != null && sAlias != null) DrawTargetAlias(sTarget, sAlias, data);
                ...
                while (true)
                {
                    ...
                    if (dataProperty.NextVisible(false) == false) break;
                }

                if (sTarget == null && data != null) DrawAutoFill(tgt, data);
            }
            else
            {
