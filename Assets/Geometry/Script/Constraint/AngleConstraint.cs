...
namespace Manipulator
{
    ...
    [Serializable]
        ...
        public class AngleConstraint : Constraint
        {
            ...
            public override bool HasShape(Shape shape) => shape == A || shape == B || shape == C;
            ...
            {
                Vector3 ab = A.transform.position - B.transform.position;
                Vector3 cb = C.transform.position - B.transform.position;
