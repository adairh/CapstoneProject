...
public class LobbyUI : MonoBehaviour
{
    ...
    private readonly float minLoadingDisplayTime = 8.0f;
    private readonly Queue<string> statusMessageQueue = new();
    private readonly float statusRepeatCooldown = 3.0f;
    ...
    private void Awake()
    {
        ...
        if (uiCanvas == null) Debug.LogError("No Canvas found in the parent hierarchy of LobbyUI!");
    ...
    {
        while (Time.time - loadingStartTime < minLoadingDisplayTime) yield return null;
    ...
    private IEnumerator ResetPopupLockAfterFade(StatusPopup popup)
    {
        ...
        {
            var nextMessage = statusMessageQueue.Dequeue();
