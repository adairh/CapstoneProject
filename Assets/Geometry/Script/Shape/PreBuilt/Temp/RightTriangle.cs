...
{
    public class RightTriangle : Shape, ShapeMesh
    {
        public Point A, B, C;
        ...
        public float Height => (A && C) ? Vector3.Distance(A.transform.position, C.transform.position) : 0f;
        public float Hypotenuse => (B && C) ? Vector3.Distance(B.transform.position, C.transform.position) : 0f;
