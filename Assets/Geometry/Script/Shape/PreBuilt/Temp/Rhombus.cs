...
{
    public class Rhombus : Shape, ShapeMesh
    {
        ...
        public float Diagonal1 => (A && C) ? Vector3.Distance(A.transform.position, C.transform.position) : 0f;
        public float Diagonal2 => (B && D) ? Vector3.Distance(B.transform.position, D.transform.position) : 0f;
        public float Area => 0.5f * Diagonal1 * Diagonal2;
    }
}
