...
{
    public class TriangleSpawner : BaseButton
    {
        protected override void OnButtonClick()
        {
            PrebuiltSpawnPanel.Show("Tam giác thường", new string[] { "Độ dài cạnh AB", "Chiều cao từ C" }, OnConfirm);
        }
        ...
        private void OnConfirm(float[] values)
        {
            ...
            Vector3 c = new Vector3(length / 2, height, 0);
